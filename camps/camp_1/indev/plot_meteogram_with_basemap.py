...
########################################
#RETRIEVE
dmet = DATA(data_domain=data_domain, param_SFC = param_SFC, param_ML=param_ML, fctime=[0,66], modelrun="latest")
dmet.retrieve()
dmet_sfx = DAdnTA(data_domain=data_domain, param_sfx = param_sfx, fctime=[0,66], type = "sfx",  modelrun="latest")
dmet_sfx.retrieve()
...
def background_map(lonlat):
    ...
    map.readshapefile('/Users/ainajoh/Data/ISAS/shape_files/NP_S100_SHP/S100_Land_f_WGS84_2', 'S100_Land_f_WGS84_2', zorder=1000, linewidth=2)
    # Heightcontours
...
def mapwithdata(point, dirName_b2,figname_b2):
    ...
    dmap = DATA(data_domain=map_data_domain, param_SFC=param_SFC, fctime=[0, 66], modelrun="latest")
    dmap.retrieve()
