    ...
    for dt in datetime:
        ...
        for tim in np.arange(np.min(steps), np.max(steps) + 1, 1):
            ...
            if stepok == True:
                ...
                # calculate IVT
                IVT = wind_speed(
                    dmet.x_wind_ml[tidx, :, :, :], dmet.y_wind_ml[tidx, :, :, :]
                )
                # print('VEL')
                # print(np.shape(VEL))
                # print(VEL[:,100,100])
                ...
                ax1.text(
                    0,
                    1,
                    "{0}_IVT_{1}+{2:02d}".format(model, dt, tim),
                    ha="left",
                    va="bottom",
                ...
                CC = ax1.contourf(
                    ...
                    y,
                    IWV.squeeze(),
                    levels=[1.0, 2.0, 3.0, 4.0, 5, 6, 7, 8, 9, 10, 12.5, 15],
                    colors=(
                        "#FFFFFF",
                        "#ffffd9",
                        "#e0f3b2",
                ...
                ax1.text(
                    0,
                    1,
                    "{0}_IWV_{1}+{2:02d}".format(model, dt, tim),
                    ha="left",
                    va="bottom",
                    transform=ax1.transAxes,
                    color="black",
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="+",
        type=int,
        help="summing over model levels --m_level 30 64 gives lowest 35 model levels",
    )
