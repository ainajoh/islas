...
def plot_track_on_map(
    ...
    sc1 = gca.scatter(
        cr["GpsLon_deg"].values,
        cr["GpsLat_deg"].values,
        transform=ccrs.PlateCarree(),
        s=30,
        zorder=7,
        marker="o",
    ...
    if idx:
        ...
        ob = offsetbox.AnchoredText(text, loc=1, prop=dict(color="black", size=13))
