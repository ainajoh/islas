...
def Extract_from_webpage(url,names=['T1','lat','lon','Unknown','T2','T3','RH']):
    '''
    ...
    cr = pd.read_csv(url,sep='\s+',names=names)
    ...
    file = '/home/centos/progs/islas/weathervis/weathervis/data/sites.csv'
